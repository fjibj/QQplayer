...
public class SmartQQClient implements Closeable {
    ...
    //消息发送失败重发次数
    private static final long RETRY_TIMES = 20;
    ...
    private void login() {
        ...
        getVfwebqq();
        getUinAndPsessionid();
        getFriendStatus();//请求一下 get_online_buddies 页面，似乎可以避免103错误。若请求无错误发生，则表明登录成功
    }
    ...
    private void getQRCode() {
        ...
        //打开二维码图片 add by fang.jin 2016.12.2
        Image image = null;
        try {
...
//        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
     ...
     * @param msg       消息内容
     */
    public boolean sendMessageToGroup(long groupId, String msg) {
        try { //防止频繁访问造成锁定，发消息前暂停5~10秒
            Thread.sleep((int)(5000+Math.random()*(10000-5000+1)));
